	...
	<div class="shop_hd">
		...
		<div class="shop_hd_topNav">
			<div class="shop_hd_topNav_all">
				...
				<div class="shop_hd_topNav_all_left">
					<p>您好，欢迎来到<b><a href="/OnlineShop">鑫源在线商城</a></b>
		...
		<div class="shop_hd_menu">
			...
			<ul class="shop_hd_menu_nav">
				...
				<li class="${currentHome }link"><a href="http://localhost:8080/OnlineShop/home/index"><span>首页</span></a></li>
